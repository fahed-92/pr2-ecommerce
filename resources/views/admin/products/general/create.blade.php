                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="product[{{$index}}][description]"
                                                                       id="description"
                                                                   class="form-control"
                                                            ></textarea>
...
{{--                                                            </label>--}}
{{--                                                            <textarea  name="product[{{$index}}][slug]"--}}
{{--                                                                       id="description"--}}
{{--                                                                       class="form-control"--}}
{{--                                                            ></textarea>--}}
                                                ...
                                                <div class="row" >
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="product[{{$index}}][sub_category_id]" class="select2 form-control" multiple>
