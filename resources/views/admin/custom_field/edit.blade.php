                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href=""> الحقول الخاصة </a>
                                </li>
                                <li class="breadcrumb-item active"> تعديل - {{$customField -> name}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> تعديل الحقل الخاص </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                              action="{{route('admin.customfield.update',$customField -> id)}}"
                                              method="POST"
                                              enctype="multipart/form-data">
                                            @csrf

                                            <input name="id" value="{{$customField -> id}}" type="hidden">

{{--                                            <div class="form-group">--}}
{{--                                                <div class="text-center">--}}
{{--                                                    <img--}}
{{--                                                        src="{{$customField -> photo}}"--}}
...
{{--                                            </div>--}}
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i> بيانات ألحقل الخاص </h4>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> اسم الحقل الخاص
                                                                - {{__('messages.'.$customField -> translation_lang)}} </label>
                                                            <input type="text" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   value="{{$customField -> name}}"
                                                                   name="customField[0][name]">
                                                            @error("customField.0.name")
                                                    ...
                                                    <div class="col-md-6 hidden">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> أختصار
                                                                اللغة {{__('messages.'.$customField -> translation_lang)}} </label>
                                                            <input type="text" id="abbr"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   value="{{$customField -> translation_lang}}"
                                                                   name="customField[0][abbr]">

                                                            @error("customField.0.abbr")
                                                            <span class="text-danger"> هذا الحقل مطلوب</span>
                                                            @enderror
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" value="1"
                                                                   ...
                                                                   @if($customField -> active == 1)checked @endif/>
                                                            <label for="switcheryColor4"
                                                                   class="card-title ml-1">الحالة {{__('messages.'.$customField -> translation_lang)}} </label>

                                                            @error("customField.0.active")
