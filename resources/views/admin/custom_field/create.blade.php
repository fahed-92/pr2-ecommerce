                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.customfield.store')}}" method="POST"
...
{{--                                            </div>--}}
                                            ...
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-home"></i> بيانات الحقل الخاص </h4>
                                                        ...
                                                        <div class="form-group">
                                                            @if(get_languages() -> count() > 0)
                                                                @foreach(get_languages() as $index => $lang)
                                                                    ...
                                                                    <label for="projectinput1"> اسم الحقل الخاص - {{__('messages.'.$lang -> abbr)}} </label>
                                                                    <input type="text" value="" id="name"
                                                                           class="form-control"
                                                                           placeholder="  "
                                                                           name="customField[{{$index}}][name]">
                                                                    @error("customField.$index.name")
                                                    ...
                                                    <div class="col-md-6 hidden">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="abbr"
                                                                   ...
                                                                   placeholder="  "
                                                                   value="{{$lang -> abbr}}"
                                                                   name="customField[{{$index}}][abbr]">

                                                            @error("customField.$index.abbr")
                                                            <span class="text-danger"> هذا الحقل مطلوب</span>
                                                            @enderror
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            ...
                                                            @error("customField.$index.active")
                                                            <span class="text-danger"> </span>
                                                            @enderror
                                                        </div>
                                                    </div>
