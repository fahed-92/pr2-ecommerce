        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item">
                <a href=""><i class="la la-male"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">الحقول الخاصة وقيمها</span>
                    <span
                        class="badge badge badge-danger  badge-pill float-right mr-2">0</span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{ route('admin.customfield') }}"
                                          data-i18n="nav.dash.ecommerce">  عرض الكل </a>
                    </li>
                </ul>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.customfield.create')}}"
                                          data-i18n="nav.dash.ecommerce"> إضافة حقل خاص جديد  </a>
                    </li>
                </ul>
            </li>
            <li class="nav-item"><a href=""><i class="la la-male"></i>
            ...
            <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title"
                                                                                    data-i18n="nav.templates.main">منتجات</span></a>
                <ul class="menu-content">
